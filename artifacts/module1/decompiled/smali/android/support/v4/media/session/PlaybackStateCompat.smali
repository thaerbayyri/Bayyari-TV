...
.method public static fromPlaybackState(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .local v19, "customActions":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;>;"
    :goto_1
    nop
    ...
    .line 833
    .local v6, "stateCompat":Landroid/support/v4/media/session/PlaybackStateCompat;
    iput-object v0, v6, Landroid/support/v4/media/session/PlaybackStateCompat;->mStateFwk:Landroid/media/session/PlaybackState;
    ...
    .end local v6    # "stateCompat":Landroid/support/v4/media/session/PlaybackStateCompat;
    .end local v19    # "customActions":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;>;"
...
.method public getPlaybackState()Ljava/lang/Object;
    ...
    .line 851
    .local v1, "builder":Landroid/media/session/PlaybackState$Builder;
    ...
    .line 856
    invoke-static {v1, v3}, Landroid/support/v4/media/session/PlaybackStateCompat$Api21Impl;->addCustomAction(Landroid/media/session/PlaybackState$Builder;Landroid/media/session/PlaybackState$CustomAction;)V
    ...
    .line 865
    .end local v1    # "builder":Landroid/media/session/PlaybackState$Builder;
    :cond_1
    iget-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mStateFwk:Landroid/media/session/PlaybackState;
