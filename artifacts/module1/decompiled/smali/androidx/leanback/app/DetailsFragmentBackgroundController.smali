...
.method public enableParallax(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroidx/leanback/widget/ParallaxTarget$PropertyValuesHolderTarget;)V
    ...
    .end local p1    # "coverDrawable":Landroid/graphics/drawable/Drawable;
    .end local p2    # "bottomDrawable":Landroid/graphics/drawable/Drawable;
    .end local p3    # "coverDrawableParallaxTarget":Landroidx/leanback/widget/ParallaxTarget$PropertyValuesHolderTarget;
    .local v4, "coverDrawable":Landroid/graphics/drawable/Drawable;
    .local v5, "bottomDrawable":Landroid/graphics/drawable/Drawable;
    .local v6, "coverDrawableParallaxTarget":Landroidx/leanback/widget/ParallaxTarget$PropertyValuesHolderTarget;
    ...
    .line 206
    .end local v4    # "coverDrawable":Landroid/graphics/drawable/Drawable;
    .end local v5    # "bottomDrawable":Landroid/graphics/drawable/Drawable;
    .end local v6    # "coverDrawableParallaxTarget":Landroidx/leanback/widget/ParallaxTarget$PropertyValuesHolderTarget;
    .restart local p1    # "coverDrawable":Landroid/graphics/drawable/Drawable;
    .restart local p2    # "bottomDrawable":Landroid/graphics/drawable/Drawable;
    .restart local p3    # "coverDrawableParallaxTarget":Landroidx/leanback/widget/ParallaxTarget$PropertyValuesHolderTarget;
    :cond_3
    move-object v4, p1
    ...
    .end local p1    # "coverDrawable":Landroid/graphics/drawable/Drawable;
    .end local p2    # "bottomDrawable":Landroid/graphics/drawable/Drawable;
    .restart local v4    # "coverDrawable":Landroid/graphics/drawable/Drawable;
    .restart local v5    # "bottomDrawable":Landroid/graphics/drawable/Drawable;
