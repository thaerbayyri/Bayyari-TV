...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 144
    invoke-virtual {v0}, Landroidx/leanback/widget/PagingIndicator;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {v2, v3, v1, v5, v8}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    .line 149
    sget v1, Landroidx/leanback/R$styleable;->PagingIndicator_lbDotRadius:I

    sget v2, Landroidx/leanback/R$dimen;->lb_page_indicator_dot_radius:I

    invoke-direct {v0, v4, v1, v2}, Landroidx/leanback/widget/PagingIndicator;->getDimensionFromTypedArray(Landroid/content/res/TypedArray;II)I

    move-result v1

    iput v1, v0, Landroidx/leanback/widget/PagingIndicator;->mDotRadius:I

    .line 151
    iget v1, v0, Landroidx/leanback/widget/PagingIndicator;->mDotRadius:I

    const/4 v2, 0x2

    mul-int/2addr v1, v2

    iput v1, v0, Landroidx/leanback/widget/PagingIndicator;->mDotDiameter:I

    .line 152
    sget v1, Landroidx/leanback/R$styleable;->PagingIndicator_arrowRadius:I

    sget v3, Landroidx/leanback/R$dimen;->lb_page_indicator_arrow_radius:I

    invoke-direct {v0, v4, v1, v3}, Landroidx/leanback/widget/PagingIndicator;->getDimensionFromTypedArray(Landroid/content/res/TypedArray;II)I

    move-result v1

    iput v1, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowRadius:I
    ...
    iput v1, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowDiameter:I

    .line 155
    sget v1, Landroidx/leanback/R$styleable;->PagingIndicator_dotToDotGap:I
    ...
    iput v1, v0, Landroidx/leanback/widget/PagingIndicator;->mDotGap:I

    .line 157
    sget v1, Landroidx/leanback/R$styleable;->PagingIndicator_dotToArrowGap:I
    ...
    iput v1, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowGap:I

    .line 160
    sget v1, Landroidx/leanback/R$styleable;->PagingIndicator_dotBgColor:I

    sget v3, Landroidx/leanback/R$color;->lb_page_indicator_dot:I

    invoke-direct {v0, v4, v1, v3}, Landroidx/leanback/widget/PagingIndicator;->getColorFromTypedArray(Landroid/content/res/TypedArray;II)I

    move-result v1

    .line 162
    .local v1, "dotBgColor":I
    ...
    iput-object v3, v0, Landroidx/leanback/widget/PagingIndicator;->mBgPaint:Landroid/graphics/Paint;

    .line 163
    iget-object v3, v0, Landroidx/leanback/widget/PagingIndicator;->mBgPaint:Landroid/graphics/Paint;

    invoke-virtual {v3, v1}, Landroid/graphics/Paint;->setColor(I)V

    .line 164
    sget v3, Landroidx/leanback/R$styleable;->PagingIndicator_arrowBgColor:I

    sget v6, Landroidx/leanback/R$color;->lb_page_indicator_arrow_background:I

    invoke-direct {v0, v4, v3, v6}, Landroidx/leanback/widget/PagingIndicator;->getColorFromTypedArray(Landroid/content/res/TypedArray;II)I

    move-result v3

    iput v3, v0, Landroidx/leanback/widget/PagingIndicator;->mDotFgSelectColor:I

    .line 167
    iget-object v3, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowPaint:Landroid/graphics/Paint;

    if-nez v3, :cond_0

    sget v3, Landroidx/leanback/R$styleable;->PagingIndicator_arrowColor:I
    ...
    invoke-virtual {v0, v3}, Landroidx/leanback/widget/PagingIndicator;->setArrowColor(I)V
    ...
    :goto_0
    iput-boolean v3, v0, Landroidx/leanback/widget/PagingIndicator;->mIsLtr:Z
    ...
    iput v6, v0, Landroidx/leanback/widget/PagingIndicator;->mShadowRadius:I
    ...
    iput-object v6, v0, Landroidx/leanback/widget/PagingIndicator;->mFgPaint:Landroid/graphics/Paint;
    ...
    .line 177
    .local v6, "shadowOffset":I
    iget-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mFgPaint:Landroid/graphics/Paint;

    iget v10, v0, Landroidx/leanback/widget/PagingIndicator;->mShadowRadius:I
    ...
    invoke-virtual {v9, v10, v11, v12, v3}, Landroid/graphics/Paint;->setShadowLayer(FFFI)V

    .line 178
    invoke-direct {v0}, Landroidx/leanback/widget/PagingIndicator;->loadArrow()Landroid/graphics/Bitmap;

    move-result-object v9

    iput-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mArrow:Landroid/graphics/Bitmap;

    .line 179
    new-instance v9, Landroid/graphics/Rect;

    iget-object v10, v0, Landroidx/leanback/widget/PagingIndicator;->mArrow:Landroid/graphics/Bitmap;

    invoke-virtual {v10}, Landroid/graphics/Bitmap;->getWidth()I

    move-result v10

    iget-object v11, v0, Landroidx/leanback/widget/PagingIndicator;->mArrow:Landroid/graphics/Bitmap;
    ...
    iput-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowRect:Landroid/graphics/Rect;

    .line 180
    iget-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mArrow:Landroid/graphics/Bitmap;
    ...
    iget v10, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowDiameter:I

    int-to-float v10, v10

    div-float/2addr v9, v10

    iput v9, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowToBgRatio:F
    ...
    iput-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mShowAnimator:Landroid/animation/AnimatorSet;

    .line 183
    iget-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mShowAnimator:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {v0, v12, v13}, Landroidx/leanback/widget/PagingIndicator;->createDotAlphaAnimator(FF)Landroid/animation/Animator;

    move-result-object v14

    aput-object v14, v11, v8

    iget v14, v0, Landroidx/leanback/widget/PagingIndicator;->mDotRadius:I

    mul-int/2addr v14, v2

    int-to-float v14, v14

    iget v15, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowRadius:I
    ...
    .line 185
    invoke-direct {v0}, Landroidx/leanback/widget/PagingIndicator;->createDotTranslationXAnimator()Landroid/animation/Animator;
    ...
    iput-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mHideAnimator:Landroid/animation/AnimatorSet;

    .line 187
    iget-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mHideAnimator:Landroid/animation/AnimatorSet;

    new-array v10, v10, [Landroid/animation/Animator;

    invoke-direct {v0, v13, v12}, Landroidx/leanback/widget/PagingIndicator;->createDotAlphaAnimator(FF)Landroid/animation/Animator;

    move-result-object v11

    aput-object v11, v10, v8

    iget v11, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowRadius:I

    mul-int/2addr v11, v2

    int-to-float v11, v11

    iget v12, v0, Landroidx/leanback/widget/PagingIndicator;->mDotRadius:I
    ...
    .line 188
    invoke-direct {v0, v11, v12}, Landroidx/leanback/widget/PagingIndicator;->createDotDiameterAnimator(FF)Landroid/animation/Animator;
    ...
    .line 190
    iget-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mAnimator:Landroid/animation/AnimatorSet;

    new-array v2, v2, [Landroid/animation/Animator;

    iget-object v10, v0, Landroidx/leanback/widget/PagingIndicator;->mShowAnimator:Landroid/animation/AnimatorSet;

    aput-object v10, v2, v8

    iget-object v8, v0, Landroidx/leanback/widget/PagingIndicator;->mHideAnimator:Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {v0, v5, v2}, Landroidx/leanback/widget/PagingIndicator;->setLayerType(ILandroid/graphics/Paint;)V
...
.method private adjustDotPosition()V
    ...
    iput v4, v1, Landroidx/leanback/widget/PagingIndicator$Dot;->mDirection:F
...
.method private loadArrow()Landroid/graphics/Bitmap;
    ...
    .line 206
    .local v2, "arrow":Landroid/graphics/Bitmap;
