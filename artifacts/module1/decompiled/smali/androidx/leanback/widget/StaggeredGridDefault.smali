...
.method protected appendVisibleItemsWithoutCache(IZ)Z
    ...
    .line 244
    .local v7, "edgeLimitSearchIndex":I
    if-gez v7, :cond_4
    ...
    .line 255
    .end local v8    # "edgeLimit":I
    :cond_4
    iget-boolean v8, p0, Landroidx/leanback/widget/StaggeredGridDefault;->mReversedFlow:Z

    if-eqz v8, :cond_5

    invoke-virtual {p0, v3, v7, v4}, Landroidx/leanback/widget/StaggeredGridDefault;->findRowMin(ZI[I)I
    ...
    .line 256
    :cond_5
    invoke-virtual {p0, v5, v7, v4}, Landroidx/leanback/widget/StaggeredGridDefault;->findRowMax(ZI[I)I
    ...
    invoke-virtual {p0, v3, v4}, Landroidx/leanback/widget/StaggeredGridDefault;->findRowMin(Z[I)I
    ...
    :cond_7
    invoke-virtual {p0, v5, v4}, Landroidx/leanback/widget/StaggeredGridDefault;->findRowMax(Z[I)I
    ...
    .line 269
    .local v7, "edgeLimitIsValid":Z
    goto :goto_9

    .line 270
    .end local v1    # "itemIndex":I
    .end local v6    # "rowIndex":I
    .end local v7    # "edgeLimitIsValid":Z
    .end local v8    # "edgeLimit":I
    :cond_9
    ...
    .line 278
    .restart local v7    # "edgeLimitIsValid":Z
    :goto_9
    const/4 v9, 0x0

    .line 283
    .local v9, "filledOne":Z
    :goto_a
    iget v10, p0, Landroidx/leanback/widget/StaggeredGridDefault;->mNumRows:I
    ...
    .line 292
    iget-boolean v12, p0, Landroidx/leanback/widget/StaggeredGridDefault;->mReversedFlow:Z

    if-eqz v12, :cond_11

    iget v12, p0, Landroidx/leanback/widget/StaggeredGridDefault;->mNumRows:I
    ...
    invoke-virtual {p0, v1, v6, v10}, Landroidx/leanback/widget/StaggeredGridDefault;->appendVisibleItemToRow(III)I
    ...
    iget v13, p0, Landroidx/leanback/widget/StaggeredGridDefault;->mSpacing:I
    ...
    invoke-virtual {p0, v11, v6, v10}, Landroidx/leanback/widget/StaggeredGridDefault;->appendVisibleItemToRow(III)I
