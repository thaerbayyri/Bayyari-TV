...
.method private applySelectedState(Z)V
    ...
    .line 673
    iget-object v1, p0, Landroidx/leanback/widget/BaseCardView;->mAnimationTrigger:Ljava/lang/Runnable;

    .line 669
    if-nez v0, :cond_0

    .line 670
    invoke-virtual {p0, v1}, Landroidx/leanback/widget/BaseCardView;->post(Ljava/lang/Runnable;)Z
    ...
    invoke-virtual {p0, v1, v2, v3}, Landroidx/leanback/widget/BaseCardView;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method protected onLayout(ZIIII)V
    ...
    .local v2, "i":I
    :goto_1
    iget-object v4, p0, Landroidx/leanback/widget/BaseCardView;->mInfoViewList:Ljava/util/ArrayList;
    ...
    .line 477
    .local v5, "infoView":Landroid/view/View;
    ...
    .line 475
    .end local v5    # "infoView":Landroid/view/View;
    ...
    .restart local v2    # "i":I
    :goto_5
    iget-object v4, p0, Landroidx/leanback/widget/BaseCardView;->mExtraViewList:Ljava/util/ArrayList;
    ...
    .line 497
    .local v4, "extraView":Landroid/view/View;
    ...
    .line 495
    .end local v4    # "extraView":Landroid/view/View;
    :cond_9
    add-int/lit8 v2, v2, 0x1
    ...
    invoke-virtual {p0, v3, v3, v1, v2}, Landroidx/leanback/widget/BaseCardView;->onSizeChanged(IIII)V
