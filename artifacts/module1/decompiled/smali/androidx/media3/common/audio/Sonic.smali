...
.method public constructor <init>(IIFFI)V
    ...
    iput-object v0, p0, Landroidx/media3/common/audio/Sonic;->downSampleBuffer:[S
    ...
    iput-object v0, p0, Landroidx/media3/common/audio/Sonic;->inputBuffer:[S
...
.method private adjustRate(FI)V
    ...
    .line 385
    invoke-direct {p0, v3, v5, v4}, Landroidx/media3/common/audio/Sonic;->ensureSpaceForAdditionalFrames([SII)[S
    ...
    .line 389
    invoke-direct {p0, v7, v8, v1, v0}, Landroidx/media3/common/audio/Sonic;->interpolate([SIII)S
...
.method private changeSpeed(F)V
    ...
    .line 469
    invoke-direct {p0, v4, v1, p1, v2}, Landroidx/media3/common/audio/Sonic;->skipPitchPeriod([SIFI)I
    ...
    .line 471
    :cond_3
    invoke-direct {p0, v4, v1, p1, v2}, Landroidx/media3/common/audio/Sonic;->insertPitchPeriod([SIFI)I
...
.method private insertPitchPeriod([SIFI)I
    ...
    .line 437
    invoke-direct {p0, v0, v1, v3}, Landroidx/media3/common/audio/Sonic;->ensureSpaceForAdditionalFrames([SII)[S
...
.method private interpolate([SIII)S
    ...
    iget v4, p0, Landroidx/media3/common/audio/Sonic;->oldRatePosition:I
...
.method private moveNewSamplesToPitchBuffer(I)V
    ...
    iget-object v3, p0, Landroidx/media3/common/audio/Sonic;->pitchBuffer:[S
...
.method private processStreamInput()V
    ...
    .line 482
    .local v1, "s":F
    iget v2, p0, Landroidx/media3/common/audio/Sonic;->rate:F

    iget v3, p0, Landroidx/media3/common/audio/Sonic;->pitch:F
    ...
    invoke-direct {p0, v3, v5, v4}, Landroidx/media3/common/audio/Sonic;->copyToOutput([SII)V
    ...
    .line 490
    invoke-direct {p0, v2, v0}, Landroidx/media3/common/audio/Sonic;->adjustRate(FI)V
...
.method private removePitchFrames(I)V
    ...
    iget-object v2, p0, Landroidx/media3/common/audio/Sonic;->pitchBuffer:[S
...
.method public queueEndOfStream()V
    ...
    .line 152
    :cond_1
    iput v6, p0, Landroidx/media3/common/audio/Sonic;->inputFrameCount:I

    .line 153
    iput v6, p0, Landroidx/media3/common/audio/Sonic;->remainingInputToCopyFrameCount:I

    .line 154
    iput v6, p0, Landroidx/media3/common/audio/Sonic;->pitchFrameCount:I
