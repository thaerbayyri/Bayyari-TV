...
.method public constructor <init>(Landroid/content/Context;Landroidx/media3/common/Player;Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Callback;)V
    ...
    .param p3, "callback"    # Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Callback;
...
.method public constructor <init>(Landroidx/media3/session/MediaLibraryService;Landroidx/media3/common/Player;Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Callback;)V
    .locals 0
    .param p1, "service"    # Landroidx/media3/session/MediaLibraryService;
    .param p2, "player"    # Landroidx/media3/common/Player;
    .param p3, "callback"    # Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Callback;
...
.method public build()Landroidx/media3/session/MediaLibraryService$MediaLibrarySession;
    ...
    iget-object v2, p0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;->context:Landroid/content/Context;
    ...
    iget-object v4, p0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;->context:Landroid/content/Context;

    iget-object v5, p0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;->id:Ljava/lang/String;

    iget-object v6, p0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;->player:Landroidx/media3/common/Player;

    iget-object v7, p0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;->sessionActivity:Landroid/app/PendingIntent;

    iget-object v8, p0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;->customLayout:Lcom/google/common/collect/ImmutableList;

    iget-object v9, p0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;->callback:Landroidx/media3/session/MediaSession$Callback;

    iget-object v10, p0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;->tokenExtras:Landroid/os/Bundle;

    iget-object v11, p0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;->sessionExtras:Landroid/os/Bundle;
    ...
    iget-boolean v13, p0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;->playIfSuppressed:Z

    iget-boolean v14, p0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;->isPeriodicPositionUpdateEnabled:Z
...
.method public setBitmapLoader(Landroidx/media3/common/util/BitmapLoader;)Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;
    ...
    check-cast v0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession$Builder;
