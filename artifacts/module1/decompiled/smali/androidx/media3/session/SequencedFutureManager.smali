...
.method public createSequencedFuture(Ljava/lang/Object;)Landroidx/media3/session/SequencedFutureManager$SequencedFuture;
    ...
    .line 84
    .local v2, "result":Landroidx/media3/session/SequencedFutureManager$SequencedFuture;, "Landroidx/media3/session/SequencedFutureManager$SequencedFuture<TT;>;"
    iget-boolean v3, p0, Landroidx/media3/session/SequencedFutureManager;->isReleased:Z

    if-eqz v3, :cond_0

    .line 85
    invoke-virtual {v2}, Landroidx/media3/session/SequencedFutureManager$SequencedFuture;->setWithTheValueOfResultWhenClosed()V

    goto :goto_0

    .line 87
    :cond_0
    iget-object v3, p0, Landroidx/media3/session/SequencedFutureManager;->seqToFutureMap:Landroidx/collection/ArrayMap;
    ...
    .line 90
    .end local v1    # "seq":I
    .end local v2    # "result":Landroidx/media3/session/SequencedFutureManager$SequencedFuture;, "Landroidx/media3/session/SequencedFutureManager$SequencedFuture<TT;>;"
    :catchall_0
    move-exception v1
...
.method public lazyRelease(JLjava/lang/Runnable;)V
    ...
    .param p3, "releaseCallback"    # Ljava/lang/Runnable;
    ...
    .line 142
    .local v1, "releaseCallbackHandler":Landroid/os/Handler;
    ...
    .line 147
    :cond_0
    new-instance v2, Landroidx/media3/session/SequencedFutureManager$$ExternalSyntheticLambda0;

    invoke-direct {v2, p0}, Landroidx/media3/session/SequencedFutureManager$$ExternalSyntheticLambda0;-><init>(Landroidx/media3/session/SequencedFutureManager;)V

    invoke-virtual {v1, v2, p1, p2}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z

    .line 149
    .end local v1    # "releaseCallbackHandler":Landroid/os/Handler;
    :goto_0
    monitor-exit v0
...
.method public release()V
    ...
    .line 127
    .local v1, "pendingResults":Ljava/util/List;, "Ljava/util/List<Landroidx/media3/session/SequencedFutureManager$SequencedFuture<*>;>;"
    iget-object v2, p0, Landroidx/media3/session/SequencedFutureManager;->seqToFutureMap:Landroidx/collection/ArrayMap;
    ...
    .line 135
    .local v2, "result":Landroidx/media3/session/SequencedFutureManager$SequencedFuture;, "Landroidx/media3/session/SequencedFutureManager$SequencedFuture<*>;"
    invoke-virtual {v2}, Landroidx/media3/session/SequencedFutureManager$SequencedFuture;->setWithTheValueOfResultWhenClosed()V

    .line 136
    .end local v2    # "result":Landroidx/media3/session/SequencedFutureManager$SequencedFuture;, "Landroidx/media3/session/SequencedFutureManager$SequencedFuture<*>;"
    goto :goto_0
    ...
    .line 133
    .end local v1    # "pendingResults":Ljava/util/List;, "Ljava/util/List<Landroidx/media3/session/SequencedFutureManager$SequencedFuture<*>;>;"
    :catchall_0
    move-exception v1
...
.method public setFutureResult(ILjava/lang/Object;)V
    ...
    .line 104
    .local v1, "future":Landroidx/media3/session/SequencedFutureManager$SequencedFuture;, "Landroidx/media3/session/SequencedFutureManager$SequencedFuture<*>;"
    if-eqz v1, :cond_1

    .line 105
    invoke-virtual {v1}, Landroidx/media3/session/SequencedFutureManager$SequencedFuture;->getResultWhenClosed()Ljava/lang/Object;
    ...
    .line 106
    invoke-virtual {v1, p2}, Landroidx/media3/session/SequencedFutureManager$SequencedFuture;->set(Ljava/lang/Object;)Z
    ...
    .line 119
    .end local v1    # "future":Landroidx/media3/session/SequencedFutureManager$SequencedFuture;, "Landroidx/media3/session/SequencedFutureManager$SequencedFuture<*>;"
    :cond_2
    monitor-exit v0
