...
.method private constructor <init>(Landroidx/media3/exoplayer/audio/AudioOffloadSupport$Builder;)V
    .locals 1
    .param p1, "builder"    # Landroidx/media3/exoplayer/audio/AudioOffloadSupport$Builder;
    ...
    iput-boolean v0, p0, Landroidx/media3/exoplayer/audio/AudioOffloadSupport;->isSpeedChangeSupported:Z
...
.method synthetic constructor <init>(Landroidx/media3/exoplayer/audio/AudioOffloadSupport$Builder;Landroidx/media3/exoplayer/audio/AudioOffloadSupport$1;)V
    .locals 0
    .param p1, "x0"    # Landroidx/media3/exoplayer/audio/AudioOffloadSupport$Builder;
    .param p2, "x1"    # Landroidx/media3/exoplayer/audio/AudioOffloadSupport$1;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v2, Landroidx/media3/exoplayer/audio/AudioOffloadSupport;

    .line 126
    .local v2, "other":Landroidx/media3/exoplayer/audio/AudioOffloadSupport;
    iget-boolean v3, p0, Landroidx/media3/exoplayer/audio/AudioOffloadSupport;->isFormatSupported:Z

    iget-boolean v4, v2, Landroidx/media3/exoplayer/audio/AudioOffloadSupport;->isFormatSupported:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, Landroidx/media3/exoplayer/audio/AudioOffloadSupport;->isGaplessSupported:Z

    iget-boolean v4, v2, Landroidx/media3/exoplayer/audio/AudioOffloadSupport;->isGaplessSupported:Z

    if-ne v3, v4, :cond_2

    iget-boolean v3, p0, Landroidx/media3/exoplayer/audio/AudioOffloadSupport;->isSpeedChangeSupported:Z

    iget-boolean v4, v2, Landroidx/media3/exoplayer/audio/AudioOffloadSupport;->isSpeedChangeSupported:Z
    ...
    .line 123
    .end local v2    # "other":Landroidx/media3/exoplayer/audio/AudioOffloadSupport;
    :cond_3
    :goto_1
    return v1
.end method
