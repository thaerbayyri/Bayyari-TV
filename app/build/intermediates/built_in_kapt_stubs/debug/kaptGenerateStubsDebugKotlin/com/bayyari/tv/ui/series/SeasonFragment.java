...
public final class SeasonFragment extends androidx.fragment.app.Fragment {
    ...
    @org.jetbrains.annotations.NotNull()
    private java.util.Map<java.lang.Integer, ? extends java.util.List<com.bayyari.tv.domain.model.Episode>> episodesBySeason;
    @org.jetbrains.annotations.Nullable()
    private com.bayyari.tv.ui.common.adapter.EpisodeAdapter episodeAdapter;
    ...
    private final void updateEpisodes() {
    }
    
    private final void renderSeasonHeader() {
    }
    
    private final void closeSeasonPage() {
    }
