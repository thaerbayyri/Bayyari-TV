...
public abstract class MovieDao {
    ...
    java.util.List<com.bayyari.tv.data.local.entities.MovieEntity> movies, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> $completion);
    
    @androidx.room.Query(value = "DELETE FROM movies WHERE serverId = :serverId")
    @org.jetbrains.annotations.Nullable()
    ...
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.bayyari.tv.data.local.entities.MovieEntity>> observeAll(int serverId);
    
    @androidx.room.Query(value = "SELECT * FROM movies WHERE serverId = :serverId AND categoryId = :categoryId ORDER BY added DESC")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.bayyari.tv.data.local.entities.MovieEntity>> observeByCategory(int serverId, @org.jetbrains.annotations.NotNull()
    java.lang.String categoryId);
    
    @androidx.room.Query(value = "SELECT * FROM movies WHERE serverId = :serverId ORDER BY added DESC LIMIT :limit")
    @org.jetbrains.annotations.Nullable()
    ...
    kotlin.coroutines.Continuation<? super com.bayyari.tv.data.local.entities.MovieEntity> $completion);
    
    @androidx.room.Query(value = "SELECT * FROM movies WHERE serverId = :serverId AND name LIKE \'%\' || :query || \'%\' COLLATE NOCASE ORDER BY name COLLATE NOCASE ASC LIMIT 200")
    @org.jetbrains.annotations.Nullable()
