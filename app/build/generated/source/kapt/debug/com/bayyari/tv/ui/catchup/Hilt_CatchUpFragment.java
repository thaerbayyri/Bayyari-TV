...
public abstract class Hilt_CatchUpFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CatchUpFragment() {
    super();
  }

  Hilt_CatchUpFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CatchUpFragment_GeneratedInjector) this.generatedComponent()).injectCatchUpFragment(UnsafeCasts.<CatchUpFragment>unsafeCast(this));
    }
  }
