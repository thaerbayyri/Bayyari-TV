...
public abstract class Hilt_TvSeriesFragment extends VerticalGridSupportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TvSeriesFragment_GeneratedInjector) this.generatedComponent()).injectTvSeriesFragment(UnsafeCasts.<TvSeriesFragment>unsafeCast(this));
    }
  }
