...
public abstract class Hilt_ServerManagerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ServerManagerFragment() {
    super();
  }

  Hilt_ServerManagerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ServerManagerFragment_GeneratedInjector) this.generatedComponent()).injectServerManagerFragment(UnsafeCasts.<ServerManagerFragment>unsafeCast(this));
    }
  }
