...
public abstract class Hilt_LiveFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LiveFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LiveFragment_GeneratedInjector) this.generatedComponent()).injectLiveFragment(UnsafeCasts.<LiveFragment>unsafeCast(this));
    }
  }
