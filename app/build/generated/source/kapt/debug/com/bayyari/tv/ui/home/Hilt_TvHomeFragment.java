...
public abstract class Hilt_TvHomeFragment extends BrowseSupportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TvHomeFragment_GeneratedInjector) this.generatedComponent()).injectTvHomeFragment(UnsafeCasts.<TvHomeFragment>unsafeCast(this));
    }
  }
