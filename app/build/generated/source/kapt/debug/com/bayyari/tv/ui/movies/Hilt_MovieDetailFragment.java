...
public abstract class Hilt_MovieDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MovieDetailFragment() {
    super();
  }

  Hilt_MovieDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MovieDetailFragment_GeneratedInjector) this.generatedComponent()).injectMovieDetailFragment(UnsafeCasts.<MovieDetailFragment>unsafeCast(this));
    }
  }
