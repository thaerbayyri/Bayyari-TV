...
public abstract class Hilt_TvMovieFragment extends VerticalGridSupportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TvMovieFragment_GeneratedInjector) this.generatedComponent()).injectTvMovieFragment(UnsafeCasts.<TvMovieFragment>unsafeCast(this));
    }
  }
