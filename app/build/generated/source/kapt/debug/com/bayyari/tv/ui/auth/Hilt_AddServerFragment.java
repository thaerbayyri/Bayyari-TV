...
public abstract class Hilt_AddServerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddServerFragment() {
    super();
  }

  Hilt_AddServerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddServerFragment_GeneratedInjector) this.generatedComponent()).injectAddServerFragment(UnsafeCasts.<AddServerFragment>unsafeCast(this));
    }
  }
