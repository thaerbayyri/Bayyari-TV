...
public abstract class Hilt_SeasonFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SeasonFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeasonFragment_GeneratedInjector) this.generatedComponent()).injectSeasonFragment(UnsafeCasts.<SeasonFragment>unsafeCast(this));
    }
  }
