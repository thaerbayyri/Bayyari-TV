...
public abstract class Hilt_TvLiveFragment extends VerticalGridSupportFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TvLiveFragment_GeneratedInjector) this.generatedComponent()).injectTvLiveFragment(UnsafeCasts.<TvLiveFragment>unsafeCast(this));
    }
  }
