...
public abstract class Hilt_EpgFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EpgFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EpgFragment_GeneratedInjector) this.generatedComponent()).injectEpgFragment(UnsafeCasts.<EpgFragment>unsafeCast(this));
    }
  }
