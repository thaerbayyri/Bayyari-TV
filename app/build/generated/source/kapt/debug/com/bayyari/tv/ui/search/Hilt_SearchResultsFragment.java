...
public abstract class Hilt_SearchResultsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchResultsFragment() {
    super();
  }

  Hilt_SearchResultsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchResultsFragment_GeneratedInjector) this.generatedComponent()).injectSearchResultsFragment(UnsafeCasts.<SearchResultsFragment>unsafeCast(this));
    }
  }
