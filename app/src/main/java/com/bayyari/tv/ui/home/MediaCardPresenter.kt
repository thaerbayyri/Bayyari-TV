            ...
            is com.bayyari.tv.domain.model.Channel -> {
                ...
                card.mainImageView?.let { imageView ->
                    ...
                    Glide.with(card.context)
                        ...
                        .placeholder(com.bayyari.tv.R.drawable.ic_logo_tv)
                        .error(com.bayyari.tv.R.drawable.ic_logo_tv)
                        .into(imageView)
                }
            ...
            is com.bayyari.tv.domain.model.Movie -> {
                ...
                card.mainImageView?.let { imageView ->
                    ...
                    Glide.with(card.context)
                        ...
                        .placeholder(com.bayyari.tv.R.drawable.banner_tv)
                        .error(com.bayyari.tv.R.drawable.banner_tv)
                        .into(imageView)
                }
                card.titleText = item.name
            }
